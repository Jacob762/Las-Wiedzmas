...
public class Funkcje {
	...
	protected static void wyswietlenie_mapy(Mapa[][] map, int X, PrintWriter zapis, int nr_epoki) {
		...
		zapis.println(nr_epoki+";"+stan.zajace+";"+stan.welociraptory+";"+stan.krzewy_rozkoszy+";"+stan.dom_wiedzmy);
